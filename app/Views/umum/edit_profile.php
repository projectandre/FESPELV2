<div class="row">
    <div class="col-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('staff/Profile/update_profile'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="nama" id="nama" class="form-control" name="nama" placeholder="Nama" value="<?= $profile->nama; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <a href="<?= base_url('staff/Profile'); ?>" class="btn btn-outline-secondary ">Kembali</a>
                </form>
            </div>
        </div>
    </div>
